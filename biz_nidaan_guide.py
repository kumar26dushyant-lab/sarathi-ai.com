...
GUIDE_CONTENT = {
    "subscriber": {
        ...
        "steps": [
            ...
            {"hi": {"t": "तीनों Nidaan नंबर सेव करें", "b": "तीनों WhatsApp नंबर अपने फ़ोन में सेव करें, ताकि हर अपडेट समय पर मिले।"},
             "en": {"t": "Save all 3 Nidaan numbers", "b": "Save all three WhatsApp numbers in your phone so you get every update on time."}},
